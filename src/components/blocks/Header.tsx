            ...
            <div className='w-[100%] flex fixed'>
              <div className='w-[100%] h-[100%] flex bg-red '>
                ...
                <div className='w-[100%] min-h-[55px] bg-[#f5f3f3] flex justify-start items-center pl-[40px] mb-[5px] cursor-pointer'>
                  ...
                  <div className='font-medium text-[#0333ae] text-[18px] ml-[30px] '>Home</div>
                </div>
                <div className='w-[100%] min-h-[55px] flex justify-start items-center pl-[40px] mb-[5px] cursor-pointer'>
                  ...
                  <div className='font-medium text-[#0333ae] text-white text-[18px] ml-[30px] mr-[40px] '>Users</div>
                  <div className='text-[20px] text-[#0333ae] text-white font-bold cursor-pointer' onClick={toggle}>
                    {show ? (
                      <GoChevronDown/>
                    ): (<GoChevronUp/>)}
                  </div>
               ...
               {show ? (null) : (
                 ...
                 <div className='w-[100%] min-h-[5px] flex justify-start items-center pl-[90px] mb-[10px]  font-medium text-white cursor-pointer text-[18px]'>Customers</div>
                 <div className='w-[100%] min-h-[5px] flex justify-start items-center pl-[90px] mb-[10px]  font-medium text-white cursor-pointer text-[18px]'>Agents</div>
               </div>
               )}
                <div className='w-[100%] min-h-[55px]  flex justify-start items-center pl-[40px] mb-[5px] cursor-pointer'>
                  <div className='text-[20px] text-[#0333ae] text-white font-bold'>
                  ...
                  <div className='font-medium text-[#0333ae] text-white text-[18px] ml-[30px]'>Stores</div>
                </div>
                <div className='w-[100%] min-h-[55px]  flex justify-start items-center pl-[40px] mb-[5px] cursor-pointer'>
                  <div className='text-[25px] text-[#0333ae] text-white font-bold'>
                    <IoBriefcaseOutline/>
                  </div>
                  <div className='font-medium text-[#0333ae] text-white text-[18px] ml-[30px]'>Orders</div>
                </div>
                <div className='w-[100%] min-h-[55px]  flex justify-start items-center pl-[40px] mb-[5px] cursor-pointer'>
                  <div className='text-[20px] text-[#0333ae] text-white font-bold'>
                    <IoWalletOutline/>
                  </div>
                  <div className='font-medium text-[#0333ae] text-white text-[18px] ml-[30px]'>Wallet</div>
                </div>
                <div className='w-[100%] min-h-[55px]  flex justify-start items-center pl-[40px] mb-[5px]'>
                  <div className='text-[20px] text-[#0333ae] text-white font-bold'>
                    <ImAngry/>
                  </div>
                  <div className='font-medium text-[#0333ae] text-white text-[18px] ml-[30px]'>Complaints</div>
                </div>
                 <div className='flex w-[100%] min-h-[55px] justify-center items-center bg-[#7e7c7c] cursor-pointer'>
                  <div className='text-white'>Logout</div>
                 </div>
                 </div>
                 <div className='w-[100%] h-[70px] flex bg-[#fff] justify-end items-center shadow-md'>
                    ...
                    <div className=' w-[90%] h-[100%] flex justify-between items-start'>
                      <div className='w-[250px] h-[40px] bg-white border-solid mr-[15px] border-[#9ea0a0] border-[1px] flex justify-center items-center rounded-[5px]'>
                        ...
                        <div className='w-[85%] h-[100%]'>
                          <input type="text" placeholder='Search' className='w-[100%] h-[100%] pl-[5px] outline-none border-0 bg-transparent'/>
                        </div>
                      </div>
                      <div className=' w-[250px]  min-h-[100px] flex justify-between flex-col items-center'>
                        ...
                        <div className='w-[80%] flex justify-between items-center'>
                          ...
                          {show2 ? ( <div className='cursor-pointer' onClick={toggle2}>
                            <GoChevronDown/>
                           </div>) : ( <div className='cursor-pointer' onClick={toggle2}>
                            <GoChevronUp/>
                           </div>)}
                        </div>
                      </div>
                        {
                          show2 ? (null) : (<div className='w-[100%] min-h-[50px] bg-white border-[1px] border-black border-solid'></div>)
                        }
                        </div>
