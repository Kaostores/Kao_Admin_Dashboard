...
const AgentDetails: React.FC<Iprops> = ({ togleBtn }) => {
	return (
		<div
...
items-center border-[1px] border-[#0000ff] border-solid flex-col p-[20px] '>
	                 <div className="w-[100%] flex justify-between items-center">
                        <div className='text-[15px]'>Add Employee</div>
	                 ...
	                 <div className='w-[100%]'>
                        <form action="POST" className='w-[100%] flex flex-col justify-center items-center'>
                         ...
                         <div className='flex flex-col mb-[10px]'>
                           ...
                           <button className='w-[400px] h-[40px] bg-[#0000ff] text-center mt-[10px] text-white rounded-[5px]'  onClick={togleBtn}>Add Employee</button>
                        </form>
                     </div>
				</div>
			</div>
