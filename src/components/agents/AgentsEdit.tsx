...
const AgentEdit: React.FC<Iprops> = ({ togleBtn }) => {
	return (
		<div
...
items-center border-[1px] border-[#0000ff] border-solid flex-col p-[20px] '>
	                 <div className="w-[100%] flex justify-between items-center">
                        <div className='text-[15px]'>Edit Employee</div>
	                 ...
	                 <div className='w-[100%]'>
                        <form action="POST" className='w-[100%] flex flex-col justify-center items-center'>
                         ...
                         <div className='flex flex-col mb-[10px]'>
                           ...
                           <button className='w-[400px] h-[40px] bg-[#929191] text-center mt-[10px] text-white rounded-[5px] cursor-not-allowed'  onClick={togleBtn}>Save</button>
                        </form>
                     </div>
				</div>
			</div>
