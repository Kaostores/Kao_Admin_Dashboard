        ...
        <div className="w-[100%] h-[100vh] flex justify-center  lg:overflow-hidden items-center ">
            <div className="w-[100%] h-[100%] flex justify-center items-center">
              <div className="w-[50%] h-[100vh] hidden relative lg:block">
                 ...
                 <div className="w-[100%] absolute top-[20%] left-[15%] md:left-[7%] md:w-[70% ] md:top-[30%]">
                    <img src={dp} alt="" />
                 </div>
              </div>
              <div className="width-[100%] absolute top-0 z-10 sm:top-[40px]">
                <img src={kao} alt="" />
              </div>
              <div className="w-[50%] h-[100vh] relative sm:w-[100%] md:w-[100%] lg:w-[50%]">
                 ...
                 <div className="w-[500px] pt-[25px] pb-[25px] bg-slate-900  absolute top-[20%] left-[20%] rounded-[20px] bg-opacity-20 sm:w-[290px] sm:left-[15px] sm:top-[30%] smm:left-[10%] smx:left-[10%] smx:w-[350px] md:w-[600px] lg:w-[500px]">
                     <form action="POST" className="w-[100%] h-[100%] flex justify-center items-center flex-col">
                        ...
                        <div className="w-[60%] flex justify-end sm:w-[90%] md:w-[81%] lg:w-[87%]">
