    ...
    <div className=' w-[calc(100%-280px)] h-[calc(100%-70px)] bg-[#fff] pl-[20px] pt-[20px] flex justify-center items-center pb-[30px] mt-[70px]'>
      <div className='w-[100%] h-[100%] flex  items-center flex-col'>
         <div className='w-[95%] min-h-[300px] bg-[#fff] shadow-lg flex-col justify-between p-[15px]'>
          <div className='w-[100%] flex justify-between items-center'>
            ...
            <div className='flex justify-center items-center'>
              ...
              <div className=' text-[#ff3b3b] mr-[1px]'><PiArrowDownLight/></div>
              ...
              <div className='text-[14px] my-[10px] text-[#8b8c8d]'>Sales over time</div>
         ...
         <div className='w-[95%] flex justify-between items-center mt-[20px]'>
          ...
          <Card tit="Average Order Value" fig="34,254" increment="5.18%" Ic="" Cl=""/>        
         </div>
         <div className='w-[95%] flex justify-between items-center mt-[20px]'>
