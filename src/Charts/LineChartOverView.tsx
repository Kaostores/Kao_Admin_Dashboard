import {
  ...
  interface LineChartOverViewProps {
	data: {
	  sunday: { revenue: number; expense: number };
	  monday: { revenue: number; expense: number };
	  tuesday: { revenue: number; expense: number };
	  wednesday: { revenue: number; expense: number };
	  thursday: { revenue: number; expense: number };
	  friday: { revenue: number; expense: number };
	  saturday: { revenue: number; expense: number };
	};
  }
  
  const LineChartOverView = ({ data }: LineChartOverViewProps) => {
	// Format the chart data based on the API response
